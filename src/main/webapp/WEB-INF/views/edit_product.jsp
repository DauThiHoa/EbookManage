...
<html>
<head>
	<title>Ebook General Store | Add Product </title>
	...
	<div class="services-breadcrumb">
		<div class="agile_inner_breadcrumb">
			<div class="container">
				<ul class="w3_short">
					<li>
						<a style="margin-left: -16%" href="${pageContext.request.contextPath}/home">Home</a>
						<i>|</i>
					</li>
					<li>Add Product</li>
				</ul>
				...
				<div class="contact-grids1 w3agile-6">
					<div class="row">
						...
						<div class="right-w3l col-md-6">
							<input type="button" style="background-color: #28a745;" id="submit" class="btn btn-primary form-control" value="Submit">
						</div>
				</div>
			</form>
			<!-- //form -->

...
<html>
<head>
	<title>Ebook General Store | Contact </title>
...
<%--							<i class="fas fa-envelope-open rounded-circle"></i>--%>
						...
						<p>
							<a style="font-weight: bold;color:black;" href="mailto:webfurniture7@gmail.com">webfurniture7@gmail.com</a>
						</p>
					</div>
				</div>
			</div>
			...
			<form id="form" method="post">
				<div class="contact-grids1 w3agile-6">
					...
					<c:choose>
						...
						<div class="col-md-6 col-sm-6 contact-form1 form-group">
							<label class="col-form-label" style="font-weight: bold">E-mail</label>
						...
						<div class="col-md-6 col-sm-6 contact-form1 form-group">
							<label class="col-form-label" style="font-weight: bold" style="font-weight: bold">E-mail</label>

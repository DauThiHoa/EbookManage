...
<body>
	...
	<div class="services-breadcrumb">
		<div class="agile_inner_breadcrumb">
			<div class="container">
				<ul class="w3_short">
					<li><a style="margin-left: -16%;" href="/admin/home">Home</a> <i>|</i></li>
					<li>View Products</li>
				</ul>
			</div>
		</div>
...
<%--						<th>Price($)</th>--%>
          ...
          <img src="${pageContext.request.contextPath}${product.image}" width="70" height="90" class="img img-responsiive" /></a>
							...
							<td><a href="${pageContext.request.contextPath}/admin/product/edit/${product.code}"><i class="far fa-edit"
													   style="font-size:30px;color:#117a8b;font-weight: bold"></i></a> |
  							<c:set var="fileName" value="${fn:split(product.image, '/')}" />
  							<a href="${pageContext.request.contextPath}/admin/product/delete/${product.id}/${fileName[1]}"
							   style="font-size:30px;color:orangered; font-weight: bold" onclick="return confirm('Are you sure you want to delete this product?');">

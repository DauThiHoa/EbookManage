	...
	<meta charset="UTF-8" />
	<link rel='icon' href='${pageContext.request.contextPath}/img/icon1.png' type='image/x-icon'/>
	<meta name="keywords" content="Ebook General Store, Ebook Store, General Store, Gokuldham Society, Ebook General Store Thane, Shop no.4, Grocery Shop" />
	<script>

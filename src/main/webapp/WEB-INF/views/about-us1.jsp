		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				<div class="col-lg-6 welcome-left">
					<h3 style="font-weight: bold; color: #117a8b">About Store</h3>
				...
				<div class="welcome-left">
					<br><br><h3 class="text-left" style="font-weight: bold; color: #117a8b" >&ensp;What We Do</h3>
				...
				<div class="welcome-left">
					<br><br><h3 class="text-left" style="font-weight: bold; color: #117a8b">&ensp;Our Vision</h3>
